...
const MIN_INSTANCE_DISK_REQUIREMENT = 1 * 1024 * 1024 * 1024; // 1 GB
const MIN_INSTANCE_RAM_REQUIREMENT = 0.5 * 1024 * 1024 * 1024; // 512 MB 
const CONTRACT_RESOURCE_QUOTA = 0.8;

const TOTAL_FILE_SIZE = Math.floor(MIN_INSTANCE_DISK_REQUIREMENT * CONTRACT_RESOURCE_QUOTA);
...
const PWHASH_MEM_LIMIT = MIN_INSTANCE_RAM_REQUIREMENT * CONTRACT_RESOURCE_QUOTA;
